...
export default function Document(ctx: DocumentContext) {
  return (
    <Html dir={ctx.locale === "ar" ? "rtl" : "ltr"} lang={ctx.locale}>
      <Head>
        <title>
          مكتب محاسبة ومراجعة M1 GROUP للاستشارات الضريبية والقانونية
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="مكتب محاسبة ومراجعة M1 GROUPللاستشارات الضريبية والقانونية"
        />
        <meta
          property="og:description"
          content="    مكتب محمد رزق و شركاه للمحاسبه القانونية و الضرائب كافه المهام الورقيه والاجراءات القانونيه مع المتابعه المستمرة وتخليص الاجراءات الحكوميه لتأسيس شركتك   ."
        />
